...
//   void initState() {
//     super.initState();
//     // Replace with secure storage or state management if needed
//     context.read<AdsCubit>().fetchAds('your_token_here');
//   }
//
//   @override
...
//                 final List<String> imageUrls = [state.ads.imageUrl]; // if more ads later, change to list
//                 return Column(
//                   children: [
//                     CarouselSlider(
//                       items: imageUrls
